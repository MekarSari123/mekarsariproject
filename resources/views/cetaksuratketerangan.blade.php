...
<style>
    ...
    #frame-saya {
        ...
        /* Tambahkan border dengan ketebalan, gaya, dan warna */
        padding: 20px;
        /* Tambahkan ruang di dalam frame */
        background-color: #e9ecef;
        /* Beri warna latar belakang */
        box-shadow: 5px 5px 10px grey;
        /* Tambahkan bayangan (opsional) */
        margin: 20px auto;
        /* Pusatkan frame secara horizontal (opsional) */
    }
</style>
@section('container')
    <center>
        <a href="/cetaksuratketerangan11/{{ $surat->id }}"><button class="no-print">Cetak Surat PDF</button></a>

        <a href="/cetaksuratketeranganword/{{ $surat->id }}"><button class="no-print">Cetak Surat Word</button></a>
    </center>
    <div id="frame-saya" class="print-only">
            ...
            <table align="center" border="0" cellpadding="1" style="width: 700px;">
                ...
                <tr>
                    ...
                    <td style="width:20%">
                        Nama</td>
                    <td style="width:5%">:</td>
                    <td style="width:70%">{{ $surat->penduduk->nama }}</td>
                </tr>
                <tr>
                    <td>
                        2.</td>
