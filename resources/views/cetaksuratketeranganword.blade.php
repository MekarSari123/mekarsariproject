...
<body>
        ...
        <table align="center" border="0" cellpadding="1" style="width: 700px;">
            ...
            <tr>
                ...
                <td colspan="2" style="border-bottom:2px solid black;">
                    ...
                    <div align="center"> <span style="font-family: arial; font-size: large;">PEMERINTAH KOTA BALIKPAPAN
                            <br>
    ...
    <?php
    header('Content_Type: application/vnd.ms-word');
    header('Expires:0');
    header('Cache-Control: must-revalidate, post-check-0, pre-check-0');
    header('content-disposition: attachment;filename=P22.doc');
    ?>
